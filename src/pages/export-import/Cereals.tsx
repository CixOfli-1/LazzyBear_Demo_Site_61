    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-64 md:h-80 w-full flex items-center justify-center" style={{ backgroundImage: 'url(/images/export-import-herobanner.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">Cereals Export & Import</h1>
        </div>
      </div>
      {/* Main Content */}
      <div className="text-center mb-8">
        <div className="text-green-600 font-semibold tracking-widest mb-2 uppercase">Cereals</div>
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Global Grain Trade Expertise</h2>
        <p className="text-lg text-gray-700 max-w-2xl mx-auto">
          We offer reliable export and import solutions for cereals and grains, meeting global standards for quality and safety. Connect with trusted suppliers and buyers worldwide.
        </p>
      </div>
      <div className="flex flex-col md:flex-row items-start justify-center gap-8 mb-12">
        <div className="bg-white rounded-xl shadow p-6 flex items-center justify-center" style={{width:496, height:496}}>
          <img src="/images/Cereals.jpeg" alt="Cereals" className="w-[400px] h-[400px] object-cover rounded-xl" />
        </div>
        <div className="flex-1 max-w-xl">
          <h3 className="text-2xl font-bold mb-2">Overview of Cereals Export & Import</h3>
          <p className="text-gray-700 mb-4">
            Our services include sourcing, quality control, and logistics for wheat, corn, barley, rice, and more. We ensure compliance with international regulations and timely delivery.
          </p>
          <ul className="list-disc list-inside text-gray-700 mb-4 text-left mx-auto max-w-md">
            <li>Sourcing, quality control, and logistics</li>
            <li>Wheat, corn, barley, rice, and more</li>
            <li>Compliance with international regulations</li>
            <li>Timely delivery and reliable supply chains</li>
            <li>Competitive pricing and personalized support</li>
          </ul>
        </div>
      </div>
      ...
      <div className="text-center mt-12">
        <h4 className="text-xl font-semibold mb-2">Ready to trade in cereals?</h4>
        <p className="mb-4 text-gray-700">Contact us to optimize your cereals export/import operations!</p>
