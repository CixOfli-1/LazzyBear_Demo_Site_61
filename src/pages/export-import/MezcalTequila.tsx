    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-64 md:h-80 w-full flex items-center justify-center" style={{ backgroundImage: 'url(/images/export-import-herobanner.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">Mezcal & Tequila Export & Import</h1>
        </div>
      </div>
      {/* Main Content */}
      <div className="text-center mb-8">
        <div className="text-green-600 font-semibold tracking-widest mb-2 uppercase">Mezcal & Tequila</div>
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Premium Spirits for Global Markets</h2>
        <p className="text-lg text-gray-700 max-w-2xl mx-auto">
          Source authentic mezcal and tequila from renowned producers. We facilitate international trade for premium spirits, ensuring compliance and quality.
        </p>
      </div>
      <div className="flex flex-col md:flex-row items-start justify-center gap-8 mb-12">
        <div className="bg-white rounded-xl shadow p-6 flex items-center justify-center" style={{width:496, height:496}}>
          <img src="/images/Mezcal-Tequila.jpeg" alt="Mezcal & Tequila" className="w-[400px] h-[400px] object-cover rounded-xl" />
        </div>
        <div className="flex-1 max-w-xl">
          <h3 className="text-2xl font-bold mb-2">Overview of Mezcal & Tequila Export & Import</h3>
          <p className="text-gray-700 mb-4">
            Our export/import services cover a wide range of mezcal and tequila brands, from artisanal to large-scale production. We handle logistics, documentation, and regulatory requirements for smooth cross-border trade.
          </p>
          <ul className="list-disc list-inside text-gray-700 mb-4 text-left mx-auto max-w-md">
            <li>Artisanal and large-scale brands</li>
            <li>Logistics, documentation, and regulatory compliance</li>
            <li>Supplier network and market expansion</li>
            <li>Competitive pricing and reliable sourcing</li>
            <li>Expert support in the international spirits industry</li>
          </ul>
        </div>
      </div>
      ...
      <div className="text-center mt-12">
        <h4 className="text-xl font-semibold mb-2">Ready to trade in premium spirits?</h4>
        <p className="mb-4 text-gray-700">Contact us to optimize your mezcal & tequila export/import operations!</p>
