    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-64 md:h-80 w-full flex items-center justify-center" style={{ backgroundImage: 'url(/images/fishing-herobanner.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-2 uppercase">ÇEŞME</h1>
          <div className="text-lg">İzmir</div>
        </div>
      </div>
      {/* Main Content */}
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-8">
          <div className="text-green-600 font-semibold tracking-widest mb-2 uppercase">Çeşme</div>
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Çeşme Fishing Guide</h2>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Çeşme is known for its beautiful coastline and excellent fishing opportunities, especially for bluefish and sea bream. It is a great spot for both beginners and experienced anglers.
          </p>
        </div>
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
          <img src="/images/cesme-fishing.png" alt="Çeşme" className="w-full md:w-1/2 rounded-xl shadow-lg object-cover" style={{ minHeight: 280 }} />
          <div className="flex-1">
            <h3 className="text-2xl font-bold mb-2">Overview of Çeşme Fishing</h3>
            <p className="text-gray-700 mb-4">
              Çeşme offers a unique fishing experience with its rich marine life, beautiful beaches, and clear waters. You can enjoy boat tours, fishing charters, and catch a variety of fish species.
            </p>
            <ul className="list-disc list-inside text-gray-700 mb-4">
              <li>Excellent fishing for bluefish and sea bream</li>
              <li>Beautiful coastline and clear waters</li>
              <li>Popular for both beginners and experienced anglers</li>
        ...
        <div className="text-center mt-12">
          <h4 className="text-xl font-semibold mb-2">Ready for a fishing adventure in Çeşme?</h4>
