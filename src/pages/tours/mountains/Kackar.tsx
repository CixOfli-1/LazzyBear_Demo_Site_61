    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-8">
          <div className="text-green-600 font-semibold tracking-widest mb-2 uppercase">Mount Kaçkar</div>
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Mount Kaçkar Travel Guide</h2>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Mount Kaçkar is a stunning mountain in the Black Sea region, known for its lush green landscapes, alpine lakes, and trekking routes. It is a paradise for hikers, nature lovers, and adventure seekers.
          </p>
        </div>
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
          <img src="/images/Mount-Kackar.png" alt="Mount Kaçkar" className="w-full md:w-1/2 rounded-xl shadow-lg object-cover" style={{ minHeight: 280 }} />
          <div className="flex-1">
            <h3 className="text-2xl font-bold mb-2">Overview of Mount Kaçkar</h3>
            <p className="text-gray-700 mb-4">
              Mount Kaçkar is famous for its alpine meadows, glacial lakes, and diverse flora and fauna. The region offers some of the best trekking and camping experiences in Turkey.
            </p>
            <ul className="list-disc list-inside text-gray-700 mb-4">
              <li>Highest peak in the Eastern Black Sea (3,937 m)</li>
              <li>Famous for trekking and hiking routes</li>
              <li>Rich biodiversity and stunning alpine scenery</li>
              <li>Picturesque villages and local culture</li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center mt-12">
          <h4 className="text-xl font-semibold mb-2">Ready to discover Mount Kaçkar?</h4>
