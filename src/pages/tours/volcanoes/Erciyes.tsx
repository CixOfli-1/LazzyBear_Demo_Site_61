    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-64 md:h-80 w-full flex items-center justify-center" style={{ backgroundImage: 'url(/images/Volcanoes-herobanner.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">Erciyes Volcano</h1>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-8">
          <div className="text-green-600 font-semibold tracking-widest mb-2 uppercase">Erciyes Volcano</div>
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Erciyes Volcano Travel Guide</h2>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Erciyes is an ancient stratovolcano and a popular destination for winter sports and mountaineering. It offers spectacular views and is a favorite among adventure seekers.
          </p>
        </div>
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
          <img src="/images/Erciyes-Volcano.png" alt="Erciyes Volcano" className="w-full md:w-1/2 rounded-xl shadow-lg object-cover" style={{ minHeight: 280 }} />
          <div className="flex-1">
            <h3 className="text-2xl font-bold mb-2">Overview of Erciyes Volcano</h3>
            <p className="text-gray-700 mb-4">
              Erciyes Volcano is renowned for its ski resorts, challenging climbing routes, and panoramic views. The area is ideal for winter sports, hiking, and nature photography.
            </p>
            <ul className="list-disc list-inside text-gray-700 mb-4">
              <li>Ancient stratovolcano in Central Anatolia</li>
        ...
        <div className="text-center mt-12">
          <h4 className="text-xl font-semibold mb-2">Ready to explore Erciyes Volcano?</h4>
