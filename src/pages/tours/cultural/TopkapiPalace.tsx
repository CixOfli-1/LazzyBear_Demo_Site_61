    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-64 md:h-80 w-full flex items-center justify-center" style={{ backgroundImage: 'url(/images/Cultural-herobanner.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-2 uppercase">TOPKAPI PALACE</h1>
          <div className="text-lg">Istanbul</div>
        </div>
      </div>
      {/* Main Content */}
      <div className="text-center mb-8">
        <div className="text-green-600 font-semibold tracking-widest mb-2 uppercase">Topkapı Palace</div>
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Topkapı Palace Travel Guide</h2>
        <p className="text-lg text-gray-700 max-w-2xl mx-auto">
          Topkapı Palace, the heart of the Ottoman Empire for centuries, showcases imperial collections, architecture, and breathtaking views of Istanbul. It is a symbol of Ottoman grandeur and history.
        </p>
      </div>
      <div className="flex flex-col md:flex-row items-start justify-center gap-8 mb-12">
        <div className="bg-white rounded-xl shadow p-6 flex items-center justify-center" style={{width:496, height:496}}>
          <img src="/images/Topkapi-Palace.png" alt="Topkapı Palace" className="w-[400px] h-[400px] object-cover rounded-xl" />
        </div>
        <div className="flex-1 max-w-xl">
          <h3 className="text-2xl font-bold mb-2">Overview of Topkapı Palace</h3>
          <p className="text-gray-700 mb-4">
            Topkapı Palace, the heart of the Ottoman Empire for centuries, is a sprawling complex with opulent courtyards, imperial collections, and breathtaking views of the Bosphorus.
          </p>
          <ul className="list-disc list-inside text-gray-700 mb-4 text-left mx-auto max-w-md">
            <li>Residence of Ottoman sultans for 400 years</li>
            <li>Home to the Imperial Treasury and Sacred Relics</li>
            <li>Stunning courtyards and gardens</li>
            <li>Panoramic views of Istanbul</li>
      ...
      <div className="text-center mt-12">
        <h4 className="text-xl font-semibold mb-2">Ready to experience Topkapı Palace?</h4>
