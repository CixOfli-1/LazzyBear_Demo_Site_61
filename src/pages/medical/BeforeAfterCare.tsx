  ...
  <div className="bg-[#f7f9fc] min-h-screen pb-12">
    ...
    <div className="relative h-56 md:h-72 w-full flex items-center justify-center mb-8" style={{ backgroundImage: 'url(/images/hero-placeholder.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="relative z-10 text-center text-white w-full">
        <h1 className="text-3xl md:text-4xl font-extrabold uppercase tracking-widest">BEFORE & AFTER CARE</h1>
      </div>
    </div>
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 px-4">
      {/* Left: Main Content */}
      <div className="flex-1">
        <h2 className="text-2xl font-bold mb-2">Your Comfort, Our Priority</h2>
        <p className="text-gray-700 mb-4">Our Before & After Care service ensures you are fully supported throughout your medical journey. From your first questions to your safe return home, we provide guidance, comfort, and expert care every step of the way.</p>
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="flex-1 min-w-[220px] h-56 bg-gray-200 rounded-lg flex items-center justify-center overflow-hidden">
            <span className="text-gray-400 text-xl">[Before Care Image]</span>
          </div>
          <div className="flex-1 min-w-[220px] h-56 bg-gray-200 rounded-lg flex items-center justify-center overflow-hidden">
            <span className="text-gray-400 text-xl">[After Care Image]</span>
          </div>
        </div>
        <h3 className="text-xl font-semibold mb-2 mt-8">What We Offer</h3>
        <ul className="list-disc pl-6 text-gray-700 space-y-1 mb-8">
          <li>Personalized pre-treatment guidance and preparation</li>
          <li>24/7 support during your stay</li>
          <li>Post-treatment follow-up and recovery tips</li>
          <li>Assistance with travel, accommodation, and transfers</li>
          <li>Multilingual coordinators for your peace of mind</li>
        </ul>
        <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded mb-8">
          <span className="font-semibold text-blue-700">Did you know?</span> Our dedicated care team is available before, during, and after your procedure to answer all your questions and make your experience stress-free.
        </div>
      </div>
      {/* Right: Sidebar */}
