  ...
  <div className="bg-[#f7f9fc] min-h-screen pb-12">
    ...
    <div className="relative h-64 md:h-80 w-full flex items-center justify-center mb-8" style={{ backgroundImage: 'url(/images/hero-placeholder.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="relative z-10 text-center text-white w-full">
        <h1 className="text-4xl md:text-5xl font-extrabold uppercase tracking-widest">ENDODONTIC</h1>
      </div>
    </div>
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 px-4">
      {/* Left: Main Content */}
      <div className="flex-1">
        <h2 className="text-2xl font-bold mb-2">Comprehensive Endodontic Treatments</h2>
        <p className="text-gray-700 mb-4">Endodontic treatment, commonly known as root canal therapy, is essential for saving teeth affected by infection or deep decay. Our experienced endodontists use advanced techniques to ensure pain-free, effective, and long-lasting results for every patient.</p>
        ...
        <p className="text-gray-700 mb-4">Our endodontic service includes a comprehensive approach to root canal therapy, ensuring comfort and patient satisfaction:</p>
        <ol className="list-decimal pl-6 text-gray-700 space-y-1 mb-8">
          <li>Thorough diagnosis and digital imaging.</li>
          <li>Pain-free root canal treatment with modern anesthesia.</li>
          <li>Preservation of natural tooth structure.</li>
          <li>Expert endodontists and advanced technology.</li>
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-4">
          ...
          <ul className="space-y-2">
            {dentalTreatmentServices.map((service) => (
              <li key={service.link}>
                <a href={service.link} className={`text-blue-700 hover:underline ${service.name === 'Endodontic' ? 'font-semibold' : ''}`}>{service.name}</a>
              </li>
            ))}
          </ul>
        </div>
