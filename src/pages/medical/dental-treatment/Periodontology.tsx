  ...
  <div className="bg-[#f7f9fc] min-h-screen pb-12">
    ...
    <div className="relative h-64 md:h-80 w-full flex items-center justify-center mb-8" style={{ backgroundImage: 'url(/images/hero-placeholder.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="relative z-10 text-center text-white w-full">
        <h1 className="text-4xl md:text-5xl font-extrabold uppercase tracking-widest">PERIODONTOLOGY</h1>
      </div>
    </div>
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 px-4">
      {/* Left: Main Content */}
      <div className="flex-1">
        <h2 className="text-2xl font-bold mb-2">Comprehensive Periodontology Treatments</h2>
        <p className="text-gray-700 mb-4">Periodontology focuses on the prevention, diagnosis, and treatment of gum diseases. Our experienced periodontists use advanced techniques to restore and maintain healthy gums, ensuring the foundation for a beautiful and lasting smile.</p>
        ...
        <p className="text-gray-700 mb-4">Our periodontology service includes a comprehensive approach to gum health, ensuring comfort and patient satisfaction:</p>
        <ol className="list-decimal pl-6 text-gray-700 space-y-1 mb-8">
          <li>Thorough gum assessment and digital imaging.</li>
          <li>Non-surgical and surgical gum treatments.</li>
          <li>Advanced techniques for gum regeneration.</li>
          <li>Expert periodontists and personalized care.</li>
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-4">
          ...
          <ul className="space-y-2">
            {dentalTreatmentServices.map((service) => (
              <li key={service.link}>
                <a href={service.link} className={`text-blue-700 hover:underline ${service.name === 'Periodontology' ? 'font-semibold' : ''}`}>{service.name}</a>
              </li>
            ))}
          </ul>
        </div>
