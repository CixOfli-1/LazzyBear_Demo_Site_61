  ...
  <div className="bg-[#f7f9fc] min-h-screen pb-12">
    ...
    <div className="relative h-64 md:h-80 w-full flex items-center justify-center mb-8" style={{ backgroundImage: 'url(/images/medical-services-images/medical-herobanner.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="relative z-10 text-center text-white w-full">
        <h1 className="text-4xl md:text-5xl font-extrabold uppercase tracking-widest">STEM CELL HAIR TRANSPLANT</h1>
      </div>
    </div>
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 px-4">
      {/* Left: Main Content */}
      <div className="flex-1">
        <h2 className="text-2xl font-bold mb-2">Complete Stem Cell Hair Transplant Solutions</h2>
        <p className="text-gray-700 mb-4">Stem cell hair transplant is an innovative technique that uses the regenerative power of stem cells to promote natural hair growth. This advanced method is ideal for those seeking a minimally invasive and highly effective solution for hair loss. Our clinic in Turkey offers the latest technology and personalized care for every patient.</p>
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="flex-1 min-w-[220px] h-64 bg-gray-200 rounded-lg flex items-center justify-center overflow-hidden">
            <img
              src="/images/medical-services-images/services-images/stem-cell-hair-transplant-1.png"
              alt="Stem Cell Hair Transplant 1"
          ...
          <div className="flex-1 min-w-[220px] h-64 bg-gray-200 rounded-lg flex items-center justify-center overflow-hidden">
            <img
              src="/images/medical-services-images/services-images/stem-cell-hair-transplant-2.png"
              alt="Stem Cell Hair Transplant 2"
              className="object-cover w-full h-full rounded-lg"
              loading="lazy"
            />
          </div>
        ...
        <p className="text-gray-700 mb-4">Our stem cell hair transplant service includes a comprehensive approach to hair restoration, ensuring natural results and patient satisfaction:</p>
        <ol className="list-decimal pl-6 text-gray-700 space-y-1 mb-8">
          <li>Personalized consultation and hair analysis by experts.</li>
          <li>Minimally invasive stem cell extraction and implantation.</li>
          <li>Advanced technology for maximum graft survival and natural growth.</li>
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-4">
          ...
          <ul className="space-y-2">
            {hairTransplantServices.map((service) => (
              <li key={service.link}>
                <a href={service.link} className={`text-blue-700 hover:underline ${service.name === 'Stem Cell Hair Transplant' ? 'font-semibold' : ''}`}>{service.name}</a>
              </li>
            ))}
          </ul>
        </div>
...
export default StemCellHairTransplant; 